...
class Analysis{
    ...
    Double_t resoMeanAmpL=0;
    Double_t resoErrRightAmp=0;
    Double_t resoErrLeftAmp=0;
    Double_t resoErrMeanAmpR=0;
    Double_t resoErrMeanAmpL=0;
    Double_t efficiencyAmp=0;
